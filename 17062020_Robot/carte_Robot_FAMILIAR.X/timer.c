...
float frequenceT1 = 200;
float frequenceT4 = 200;
...
void __attribute__((interrupt, no_auto_psv)) _T1Interrupt(void)
{
    ...
    QEIUpdateData();
    if (timestamp - lastDataSend >= 20 || timestamp < lastDataSend)
    {
        SendPositionData();
        lastDataSend = timestamp;
    }  
}


//Initialisation d'un autre timer 16 bits
void InitTimer4(void)
{
    SetFreqTimer4(frequenceT4);
...
//Reinitialisation du temps ecoule
