...
#define OBSTACLE_ELOIGNE 4
#define OBSTACLE_CENTRE_DROIT 5
#define OBSTACLE_CENTRE_GAUCHE 6
#define OBSTACLE_E_DROIT 7
#define OBSTACLE_E_GAUCHE 8
#define OBSTACLE_CRITIQUE_DROITE 9
#define OBSTACLE_CRITIQUE_GAUCHE 10
